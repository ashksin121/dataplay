				...
				<div class="col-lg-8">
					...
					<div class="course_container">
						...
						<div>
							...
							<?php } elseif($check===2) {?>
								<form>
						         	<button type="submit" class="btn btn-outline-primary" formaction="<?=CTRL?>Main/checkout/3">Register to Course</button>
						      	</form>
						    <?php } else {?>
						    	<a href="<?=CTRL?>Main/course_dl/" class="btn btn-outline-primary" role="button">Go to Course</a>
						    <?php }?>
