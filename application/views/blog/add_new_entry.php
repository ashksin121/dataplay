      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          ...
          <!--   <?php echo validation_errors(); ?>
            ...
            <form name="new_entry" action="<?=  base_url()?>index.php/Main/add_new_entry/" method="post">          
              <div class="form-group">
              <label for="title">Title:</label>
              <input type="text" class="form-control" id="title" name="entry_name">
            </div>

            <div class="form-group">
              <label for="comment">Body:</label>
              <textarea class="form-control" rows="5" id="comment" style="resize: none;" name="entry_body"></textarea>
            </div>

            <button type="submit" class="btn btn-outline-primary">Submit</button>
            </form>

            <!-- <h2><a style="color: green" href="<?=  base_url()?>index.php/Main/add_new_entry/"><i style='font-size:24px' class='fas'>&#xf044;</i> Create a new post</a></h2> -->
