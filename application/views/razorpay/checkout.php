...
<div class="super_container">
  ...
  <div class="container">
  	...
  	<h1>Checkout</h1>
  	<br>
      <h2><?php echo $itemInfo['data']['name'] ?></h2>
      <br>
      <h2 style="padding-left:3em">Price: INR <?php echo $itemInfo['data']['price']?></h2>
      <br>
...
$return_url = CTRL.'Main/subscr';
?>

<!-- <h3>Here here</h3> -->
<form name="razorpay-form" id="razorpay-form" action="<?php echo $return_url; ?>/<?php echo $id ?>" method="POST">
